...
export default function FetchCSVData(props) {
    ...
    const fetchCSVData = () => {
    const csvUrl = 'https://docs.google.com/spreadsheets/d/1v3WDHKdKRMSPD2DNfYEWuGm8cw7apCzgbj1_qsSfRnY/edit#gid=0'; // Replace with your Google Sheets CSV file URL
